...
export const metadata = {
  title: 'URL Formats - Copy URLs in Multiple Formats',
  description:
    'Learn about different URL formats in Umbrella: HTML, JSON, Plain Text, Markdown, and Custom Templates. Copy browser tabs in the format that suits your workflow.',
  keywords: [
    'url formats',
    'html format',
    'json format',
  ...
  openGraph: {
    title: 'URL Formats - Umbrella Documentation',
    description:
      'Complete guide to copying URLs in multiple formats: HTML, JSON, Plain Text, Markdown, and Custom Templates.',
    url: 'https://tabs.clasicwebtools.com/docs/formats',
  },
};
...
<Shot
  shape="wide"
  src="tour-formats"
  ariaLabel="The options page switching between plain text, HTML, JSON, Markdown, and custom formats, with the copied output updating to match."
  caption="Switch the default format and the same tabs come out as text, HTML, JSON, Markdown, or your own template."
/>
