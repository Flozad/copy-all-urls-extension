...
- **GitHub Issues**: [Open an issue](https://github.com/Flozad/copy-all-urls-extension/issues)
- **Email Support**: [clasicwebtools@gmail.com](mailto:clasicwebtools@gmail.com)
